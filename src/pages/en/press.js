...
const Press = () => {
    return (
        <section id="press" style={styles.section}>
            <h1 style={styles.title}>Press</h1>

            {/* Press Releases Section */}
            <div style={styles.pressReleases}>
                <h2 style={styles.subtitle}>Press Releases</h2>
            ...
            <div style={styles.pressCoverage}>
                <h2 style={styles.subtitle}>VisionDevCamp Press Coverage</h2>
                <p style={styles.text}>
	          Below is a list of blog entries, articles, and podcasts concerning VisionDevCamp.
                </p>
                <ul style={styles.list}>
